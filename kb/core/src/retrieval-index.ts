...
export { createRetriever, LanceRetriever, LANCE_DB_SUBDIR, FTS5_DB_SUBDIR, type Retriever, type ReindexResult } from './retrieval/retriever.js'
...
export { SEARCH_MODES, type SearchMode, type SearchOptions, type SearchResult, type TextChunkRow } from './retrieval/types.js'
