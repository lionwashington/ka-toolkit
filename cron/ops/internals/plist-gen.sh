...
: "${KA_REPO_ROOT:?KA_REPO_ROOT required}"
...
RUNNER="${KA_REPO_ROOT}/cron/ops/cron-run.sh"
PARSER="${KA_REPO_ROOT}/cron/ops/internals/schedule-parser.sh"
